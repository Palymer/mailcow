...
if [ -f /opt/mailcow-dockerized/mailcow.conf ]; then
  ...
  case $response in
    [yY][eE][sS]|[yY])
      mv /opt/mailcow-dockerized/mailcow.conf /opt/mailcow-dockerized/mailcow.conf_backup
      chmod 600 /opt/mailcow-dockerized/mailcow.conf_backup
      ;;
    *)
      exit 1
      ;;
...
[ ! -f /opt/mailcow-dockerized/data/conf/rspamd/override.d/worker-controller-password.inc ] && echo '# Placeholder' > /opt/mailcow-dockerized/data/conf/rspamd/override.d/worker-controller-password.inc

cat << EOF > /opt/mailcow-dockerized/mailcow.conf
# ------------------------------
...
mkdir -p /opt/mailcow-dockerized/data/assets/ssl

chmod 600 /opt/mailcow-dockerized/mailcow.conf

# copy but don't overwrite existing certificate
echo "Generating snake-oil certificate..."
# Making Willich more popular
openssl req -x509 -newkey rsa:4096 -keyout /opt/mailcow-dockerized/data/assets/ssl-example/key.pem -out /opt/mailcow-dockerized/data/assets/ssl-example/cert.pem -days 365 -subj "/C=DE/ST=NRW/L=Willich/O=mailcow/OU=mailcow/CN=${MAILCOW_HOSTNAME}" -sha256 -nodes
echo "Copying snake-oil certificate..."
cp -n -d /opt/mailcow-dockerized/data/assets/ssl-example/*.pem /opt/mailcow-dockerized/data/assets/ssl/
...
if [ $? -eq 0 ]; then
  echo '<?php' > /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_VERSION="'$mailcow_git_version'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_LAST_GIT_VERSION="";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_OWNER="mailcow";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_REPO="mailcow-dockerized";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_URL="https://github.com/mailcow/mailcow-dockerized";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_COMMIT="'$mailcow_git_commit'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_COMMIT_DATE="'$mailcow_git_commit_date'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_BRANCH="'$git_branch'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_UPDATEDAT='$(date +%s)';' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '?>' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
else
  echo '<?php' > /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_VERSION="'$mailcow_git_version'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_LAST_GIT_VERSION="";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  ...
  echo '  $MAILCOW_GIT_REPO="mailcow-dockerized";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_URL="https://github.com/mailcow/mailcow-dockerized";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_COMMIT="";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_GIT_COMMIT_DATE="";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_BRANCH="'$git_branch'";' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '  $MAILCOW_UPDATEDAT='$(date +%s)';' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
  echo '?>' >> /opt/mailcow-dockerized/data/web/inc/app_info.inc.php
